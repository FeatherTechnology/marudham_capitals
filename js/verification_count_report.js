...
$(document).ready(function () {
  ...
  $("#type").change(function (e) {
    ...
    if ($.fn.DataTable.isDataTable("#verification_count_table")) {
      $("#verification_count_table").DataTable().clear().destroy();

      $("#verification_count_table tbody").empty(); // Remove old rows
      $("#verification_count_table tfoot").empty(); // Remove old footer
    }
...
function verificationReportCount(
  from_date,
  to_date,
  selectedType,
  user_type,
