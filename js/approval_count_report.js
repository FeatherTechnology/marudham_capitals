...
$(document).ready(function () {
  ...
  $("#type").change(function (e) {
    ...
    if ($.fn.DataTable.isDataTable("#approval_count_table")) {
      $("#approval_count_table").DataTable().clear().destroy();

      $("#approval_count_table tbody").empty(); // Remove old rows
      $("#approval_count_table tfoot").empty(); // Remove old footer
    }
