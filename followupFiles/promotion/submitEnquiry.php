...
if($row_count == 0){
    $sql = $connect->prepare("INSERT INTO enquiry(cus_id, cus_data, cus_name, mobile, area, sub_area, loan_amount, insert_login_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?)");
    $sql->execute([$cus_id, $cus_data, $cus_name, $cus_mob, $area, $sub_area, $enquiry_loan_amt, $userid]);
