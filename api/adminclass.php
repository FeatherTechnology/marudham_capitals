...
class admin
{
	...
	public function getuser($mysqli, $idupd)
	{
		...
		if ($mysqli->affected_rows > 0) {
			...
			$detailrecords['noc_handover_mapping_access']              = strip_tags($row->noc_handover_mapping_access);
	...
	public function addUser($mysqli, $userid)
	{
		...
		if (isset($_POST['noc_handover_mapping_access'])) {
			$noc_handover_mapping_access = $_POST['noc_handover_mapping_access'];
		}
