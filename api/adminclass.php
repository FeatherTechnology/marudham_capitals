...
class admin
{
	...
	public function addUser($mysqli, $userid)
	{
		...
		$promotion_activity_action_access = $_POST['promotion_activity_action_access'] ?? '2';
		$download_access = '1';
