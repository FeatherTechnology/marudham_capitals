...
class admin
{
	...
	public function addUser($mysqli, $userid)
	{
		...
		if (isset($_POST['pending_od_report']) &&    $_POST['pending_od_report'] == 'Yes') {
			$pending_od_report = 0;
		} else {
			$pending_od_report = 1;
		}
