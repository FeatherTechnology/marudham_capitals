...
class admin
{
	...
	public function getuser($mysqli, $idupd)
	{
		...
		if ($mysqli->affected_rows > 0) {
			...
			$detailrecords['reactive_count_report'] = strip_tags($row->reactive_count_report);
	...
	public function addUser($mysqli, $userid)
	{
		...
		$reactive_count_report = (isset($_POST['reactive_count_report']) && $_POST['reactive_count_report'] == 'Yes') ? 0 : 1;
	...
	public function addRequest($mysqli, $userid)
	{
		...
		try {
			...
			$insertQry = "INSERT INTO request_creation(`user_type`, `user_name`, `agent_id`, `responsible`, `remarks`, `declaration`, `req_code`, `dor`, `cus_id`, `cus_data`, `cus_name`, `dob`, `age`, `gender`, `state`, `district`, `taluk`, `area`, `sub_area`, `address`, `mobile1`, `mobile2`, `father_name`, `mother_name`, `marital`, `spouse_name`, `occupation_type`, `occupation`, `pic`, `loan_category`, `sub_category`, `tot_value`, `ad_amt`, `ad_perc`, `loan_amt`, `poss_type`, `due_amt`, `due_period`, `insert_login_id`,`created_date`) 
			VALUES('$user_type', '$user', '$agent', '$responsible', '$remarks', '$declaration', '$req_code', '$dor', '$cus_id', '$cus_data', '$cus_name', '$dob', '$age', '$gender', '$state', '$district', '$taluk', '$area', '$sub_area', '$address', '$mobile1', '$mobile2', '$father_name', '$mother_name', '$marital', '$spouse_name', '$occupation_type', '$occupation', '$pic', '$loan_category', '$sub_category', '$tot_value', '$ad_amt', '$ad_perc', '$loan_amt', '$poss_type', '$due_amt', '$due_period', '$userid', CURRENT_TIMESTAMP )";
			...
			if ($cus_data == 'New') {
				...
				VALUES( '$autogen_cus_id', '$cus_id', '$req_ref_id', '$cus_name', '$dob', '$age', '$gender', '$state', '$district', '$taluk', '$area', '$sub_area', '$address', '$mobile1', '$mobile2', '$father_name', '$mother_name', '$marital', '$spouse_name', '$occupation_type', '$occupation', '$pic' )";
				$mysqli->query($CustomerInsert) or die("Error " . $mysqli->error);
				
			} elseif ($cus_data == 'Existing') {
				$mysqli->query("UPDATE customer_register SET `autogen_cus_id` = '$autogen_cus_id', `cus_id` = '$cus_id', `req_ref_id` = '$req_ref_id', `customer_name` = '$cus_name', `dob` = '$dob', `age` = '$age', `gender` = '$gender', `state` = '$state', `district` = '$district', `taluk` = '$taluk', `area` = '$area', `sub_area` = '$sub_area', `address` = '$address', `mobile1` = '$mobile1', `mobile2` = '$mobile2', `father_name` = '$father_name', `mother_name` = '$mother_name', `marital` = '$marital', `spouse` = '$spouse_name', `occupation_type` = '$occupation_type', `occupation` = '$occupation', `pic` = '$pic', `cus_status` = 0 WHERE `cus_id`= '$cus_id' ");
	...
	public function updateCustomerProfile($mysqli, $userid)
	{
		...
		$insertQry = "UPDATE in_verification SET `cus_name` = '$cus_name', `gender` = '$gender', `dob` = '$dob', `age` = '$age' WHERE `cus_id` = '$cus_id' ";
		$insresult = $mysqli->query($insertQry) or die("Error " . $mysqli->error);
		...
		if (!empty($req_id_array)) {
			$cusUpd = "UPDATE `customer_profile` SET `cus_id` = '$cus_id', `cus_name` = '$cus_name', `gender` = '$gender', `dob` = '$dob', `age` = '$age', `whatsapp` = '$whatsapp_no', `cus_pic` = '$cus_pic', `residential_type` = '$cus_res_type', `residential_details` = '$cus_res_details', `residential_address` = '$cus_res_address', `residential_native_address` = '$cus_res_native', `occupation_type` = '$cus_occ_type', `occupation_details` = '$cus_occ_detail', `occupation_income` = '$cus_occ_income', `occupation_address` = '$cus_occ_address', `dow` = '$cus_occ_dow', `abt_occ` = '$cus_occ_abt', `area_confirm_type` = '$area_cnfrm', `area_confirm_state` = '$area_state', `area_confirm_district` = '$area_district', `area_confirm_taluk` = '$area_taluk', `area_confirm_area` = '$area_confirm', `area_confirm_subarea` = '$area_sub_area', `latlong` = '$latlong', `area_group` = '$area_group', `area_line` = '$area_line', `update_login_id` = '$userid', `updated_date` = NOW() WHERE req_id IN (" . implode(",", $req_id_array) . " ) ";
			$updateCus = $mysqli->query($cusUpd) or die("Error " . $mysqli->error);


			$updateACkCus = "UPDATE `acknowlegement_customer_profile` SET `cus_id` = '$cus_id', `cus_name` = '$cus_name', `gender` = '$gender', `dob` = '$dob', `age` = '$age', `whatsapp` = '$whatsapp_no', `cus_pic` = '$cus_pic', `residential_type` = '$cus_res_type', `residential_details` = '$cus_res_details', `residential_address` = '$cus_res_address', `residential_native_address` = '$cus_res_native', `occupation_type` = '$cus_occ_type', `occupation_details` = '$cus_occ_detail', `occupation_income` = '$cus_occ_income', `occupation_address` = '$cus_occ_address', `dow` = '$cus_occ_dow', `abt_occ` = '$cus_occ_abt', `area_confirm_type` = '$area_cnfrm', `area_confirm_state` = '$area_state', `area_confirm_district` = '$area_district', `area_confirm_taluk` = '$area_taluk', `area_confirm_area` = '$area_confirm', `area_confirm_subarea` = '$area_sub_area', `latlong` = '$latlong', `area_group` = '$area_group', `area_line` = '$area_line', `update_login_id` = '$userid', `updated_date` = NOW() WHERE req_id IN (" . implode(",", $req_id_array) . " ) ";
			$insresult = $mysqli->query($updateACkCus) or die("Error " . $mysqli->error);
		}
	}
