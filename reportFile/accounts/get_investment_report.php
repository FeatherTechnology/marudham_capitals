...
if (!empty($_POST['search']['value'])) {
    ...
    $query .= " WHERE sub.tdate LIKE '%$search%' OR sub.ctype LIKE '%$search%' OR sub.Credit LIKE '%$search%' OR sub.Debit LIKE '%$search%' OR sub.Amount LIKE '%$search%' OR sub.name LIKE '%$search%' ";
}
