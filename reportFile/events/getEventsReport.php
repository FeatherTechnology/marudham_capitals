...
$query = "SELECT 
    ep.event_created_date ,ep.name ,ep.mobile_num ,ep.sub_area ,ep.insert_login_id ,alc.area_name AS event_name ,slc.sub_area_name ,u.fullname
FROM 
    event_promotion ep
LEFT JOIN 
...
if (isset($_POST['search'])) {
    if ($_POST['search'] != "") {
        ...
        $query .= " AND (ep.name LIKE '%" . $_POST['search'] . "%' OR
