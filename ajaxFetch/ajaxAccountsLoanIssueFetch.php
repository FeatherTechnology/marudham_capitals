...
if ($userid == 1) {
    $query = "SELECT a.dor, a.cus_id, a.cus_name, bc.branch_name, ag.group_name, alm.line_name, ac.area_name, sa.sub_area_name, lcc.loan_category_creation_name, b.sub_category, b.loan_amt, a.user_type, a.user_name, a.agent_id, a.responsible, a.cus_data, a.cus_status, a.req_id 
