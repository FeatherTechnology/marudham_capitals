...
if ($userid == 1) {
    $query = 'SELECT v.req_id, v.cus_id, v.cus_name, v.mobile1, v.sub_category, v.loan_amt, v.user_type, v.responsible, v.cus_data, v.cus_status, v.status, v.dor, v.agent_id, cr.autogen_cus_id, a.area_name, sa.sub_area_name, ag.group_name, bc.branch_name, alm.line_name, lcc.loan_category_creation_name  
