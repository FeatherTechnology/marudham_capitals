...
$modules = [
    ...
    'report' => [
        ...
        'promotion_count_report','duefollowup_count_report','back_office_count_report','reactive_count_report','branch_request_count_report','location_track_report','outstanding_report'
    ],
								...
								<li class="sidebar-dropdown-2">
									...
									<div class="sidebar-submenu-2" style="display:none; margin-left: 25px;">
										<ul>
											...
											<?php  } ?>
											<?php if (($leftbar_reactive_count_report ?? 1) == 0) { ?>
												<li>
													<a href="reactive_count_report"><i class='icon-area-graph'></i>Renewal To Reactive</a>
												</li>
											<?php  } ?>
										</ul>
									</div>
