...
try {
    ...
    /* ✅ INSERT AGENT DEBIT (Same table ct_db_bag) */
    $insStmt = $connect->prepare(" INSERT INTO ct_db_bag 
    ...
    /* ✅ UPDATE BANK STATEMENT (Same Logic) */
    ...
    $historyStmt = $connect->prepare("INSERT INTO cleared_bank_stmt_history
        ...
        VALUES
        (:bank_stmt_id, :transaction_balance, 'Bank Agent DB', :user_id, NOW()) ");
